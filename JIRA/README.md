...
**~372 SP (QA Bench deferred) ≈ 11–12 two-week sprints (~22–24 weeks)**. **QA Bench (`QABENCH`) is out of
...
| E19 | Invoicing (Automated Client Invoice Export) | [`invoicing/`](./invoicing/) | `/invoicing` |
...
**Fastest: use the generated CSV — [`jira-import.csv`](./jira-import.csv)** (102 rows: 20 epics + 82 tasks).
